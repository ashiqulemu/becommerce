...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row site-forms">
            <form method="post" action="{{url('/admin/auction')}}" enctype="multipart/form-data">
                @csrf
                <div class="">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple form-control"
                                ...
                                <option value="Paid"
                                @if (old('auction_type') == 'Paid') {{ 'selected' }} @endif>Paid</option>

                                <option value="Free"
                                @if (old('auction_type') == 'Free') {{ 'selected' }} @endif>Free</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    type="number"
                                    step="any"
                                    value="{{ old('price_increase_every_bid') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    type="number"
                                    step="any"
                                    value="{{ old('price_drop_percentage') }}"
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <div class="slot-range" v-for="(item,index) in slotRangeData" :key="index">
                                ...
                                <button class="btn btn-primary btn-sm" style="margin-right:3px " @click.prevent="addRow()" v-if="index==0"   title="Add More">+</button>
                    ...
                    <div class="col-md-4"><br>
                        <div class="form-group">
                            ...
                            <input type="radio" checked name="status" value="Active" id="active" v-model="status"
                                   @if(!old('status')) checked @endif
                                   @if(old('status')=='Active') checked @endif
                            >
                            <label for="active">Active</label>

                            {{--<input type="radio" name="status" value="Pause" id="pause" v-model="status"--}}
                                   {{--@if(old('status')=='Pause') checked @endif--}}
                            {{-->--}}
                            {{--<label for="pause">Pause</label>--}}

                            <input type="radio" name="status" value="Inactive" id="inactive" v-model="status"
